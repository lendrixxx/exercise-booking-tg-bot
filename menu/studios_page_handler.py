...
def get_studios_keyboard(chat_id: int) -> telebot.types.InlineKeyboardMarkup:
  query_data = global_variables.CHAT_MANAGER.get_query_data(chat_id)
...
def get_locations_keyboard(chat_id: int) -> telebot.types.InlineKeyboardMarkup:
  query_data = global_variables.CHAT_MANAGER.get_query_data(chat_id)
  button_data = global_variables.CHAT_MANAGER.get_button_data(chat_id)
...
def studios_callback_query_handler(query: telebot.types.CallbackQuery) -> None:
  ...
  if selected_studio == StudioType.Null:
    ...
    global_variables.CHAT_MANAGER.update_button_data_studios_buttons_map(query.message.chat.id, button_data.studios_buttons_map)
    global_variables.CHAT_MANAGER.update_query_data_studios(query.message.chat.id, {})
    global_variables.CHAT_MANAGER.reset_button_data_studios_locations_buttons_map(query.message.chat.id)
    ...
    global_variables.CHAT_MANAGER.update_button_data_select_all_studios_locations_buttons_map(query.message.chat.id)
  ...
  global_variables.BOT.edit_message_text(
    ...
    text=text,
    reply_markup=get_studios_keyboard(query.message.chat.id),
    parse_mode="Markdown")
...
def select_location_handler(message: telebot.types.Message, selected_studio_location: StudioLocation) -> None:
  query_data = global_variables.CHAT_MANAGER.get_query_data(message.chat.id)
  button_data = global_variables.CHAT_MANAGER.get_button_data(message.chat.id)
  if selected_studio_location == StudioLocation.Null:
    ...
    global_variables.CHAT_MANAGER.update_button_data_studios_locations_buttons_map(message.chat.id, button_data.studios_locations_buttons_map)
    ...
    if query_data.current_studio not in query_data.studios:
      ...
      button_data.studios_buttons_map[query_data.current_studio] = telebot.types.InlineKeyboardButton(query_data.current_studio + " ✅", callback_data=button_data.studios_buttons_map[query_data.current_studio].callback_data)
      global_variables.CHAT_MANAGER.update_button_data_studios_buttons_map(message.chat.id, button_data.studios_buttons_map)
      global_variables.CHAT_MANAGER.update_button_data_studios_locations_buttons_map(message.chat.id, button_data.studios_locations_buttons_map)
...
def locations_callback_query_handler(query: telebot.types.CallbackQuery) -> None:
  ...
  global_variables.BOT.edit_message_text(
    ...
    text=text,
    reply_markup=get_locations_keyboard(query.message.chat.id),
    parse_mode="Markdown")
